...
private:
    ...
    ros::Subscriber sub_state = nh.subscribe("/differential_robot/Pose", 1000, &SetState::stateCallback, this);
    tf2::Quaternion q;
...
int main(int argc, char **argv){
    ...
    ros::NodeHandle nh;
    ros::Publisher pub_state = nh.advertise<gazebo_msgs::ModelState>("/gazebo/set_model_state", 1000);
    ros::Subscriber sub_state = nh.subscribe("/differential_robot/Pose", 1000, stateCallback);
    tf2::Quaternion q;
    ros::Rate rate(100);
